...
{
	import com.obis_adventure.ogmoloader.IOgmoNodeHandler;
            ...
            for each (var layer:XML in layerNodes.reverse())
            {
                ...
                else
                {
                    for each (var entity:XML in layer.children())
                    {
                        ...
                        if (ent is com.obis_adventure.ogmoloader.IOgmoNodeHandler)
                            com.obis_adventure.ogmoloader.IOgmoNodeHandler(ent).nodeHandler(entity);
